          ...
          <div className="overflow-x-auto lg:overflow-x-visible -mx-4 sm:-mx-0 mt-4">
            <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
              ...
              <tbody className="bg-white dark:bg-zinc-900 divide-y divide-zinc-100 dark:divide-zinc-800">
                {data.map(d => {
                  const sourceChainData = getChainData(d.send.source_chain, chains)
                  const destinationChainData = getChainData(d.send.destination_chain, chains)
                    ...
                    <tr key={d.send.txhash} className="align-top text-zinc-400 dark:text-zinc-500 text-sm">
                      ...
                      <td className="px-3 py-4 text-left">
                        <div className="flex flex-col gap-y-1">
                          <div className="min-w-max h-6 flex items-center gap-x-2">
                            <Image
                              src={sourceChainData?.image}
                              width={24}
                              height={24}
                            />
                            <span className="text-zinc-900 dark:text-zinc-100 font-semibold whitespace-nowrap">

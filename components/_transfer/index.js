...
import { _transfers as getTransfers, transfers_status as getTransfersStatus } from '../../lib/api/transfer'
        ...
        if (
          ...
          if (
            ...
            (
              ...
              getType(recipient_address) === 'evm_address'
            )
          ) {

...
export default ({ data }) => {
  ...
  const metricClassName = 'bg-white dark:bg-black border hover:border-transparent dark:border-slate-400 hover:dark:border-transparent shadow hover:shadow-lg dark:shadow-slate-200 rounded-lg space-y-0.5 py-4 px-5'

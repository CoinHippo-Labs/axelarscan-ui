...
export const _transfers = async params =>
  await request(
    '/_transfers',
    {
      ...params,
...
export const _transfers_status = async params =>
  await request(
    '/_transfers-status',
    {
      ...params,
...
export const _transfers_stats = async params =>
  await request(
    '/_transfers-stats',
    {
      ...params,
...
export const _transfers_chart = async params =>
  await request(
    '/_transfers-chart',
    {
      ...params,
...
export const _cumulative_volume = async params =>
  await request(
    '/_cumulative-volume',
    {
      ...params,
